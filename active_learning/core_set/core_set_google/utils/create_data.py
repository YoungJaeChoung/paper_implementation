# https://github.com/google/active-learning/blob/master/utils/create_data.py
...
import tarfile
import urllib2    # todo: python2 를 쓴건가 ... ? google 은 ... ?
"""
...
def main(argv):
    # todo: 왜 이건 사용 하는게 없지 ... ?
    del argv  # Unused.    # todo: 왜 이걸 입력받고 ㅡ 제거할까 ... ?
...
if __name__ == '__main__':
    ...
    # Todo
    """
    get_wikipedia_talk_data
    get_keras_data(dataname)
    get_cifar10()
    get_mldata(dataset)
    """
